...
vectorq_file.write("set inder = /Users/brownscholar/Desktop")
vectorq_file.write("set dir = ./test/\n")
vectorq_file.write("set fileinfo = {$dir}info_pr.dat\n")
vectorq_file.write("set filedh =  {$dir}/marine_dh"+example_date+".gr\n")
vectorq_file.write("set filest =  {$dir}/marine_copernicus_density"+example_date+".gr\n")
